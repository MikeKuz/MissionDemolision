...
public class ProjectileLine : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        //Получить ссылку на LineRanderer
        line = GetComponent<LineRenderer>();

        //Выключить LineRanderer, пока он не понадобился
        line.enabled = false;
    ...
    public void AddPoint()
    {
        ...
        {
            //Обычная последоваельность добавления точки
            points.Add(pt);
    ...
    void FixedUpdate()
    {
        ...
        //Если интересующий объект найдет, попытаться добавить точку с его координатами в каждом FixedUpdate
        AddPoint();
        if(FollowCam.POI ==null)
        {
